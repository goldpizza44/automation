...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US"
  xml:lang="en-US">
<head>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/bootstrap/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/bootstrap/css/bootstrap-slider.min.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/bootstrap/css/bootstrap-clockpicker.min.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/bootstrap/css/bootstrap-timepicker.min.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/bootstrap/css/horiz_tabscroll.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/fullcalendar/fullcalendar.css"/>
    <link rel="stylesheet" href="http://poolmonitor.goldfarbs.net/fullcalendar/fullcalendar.print.css" media="print" />

    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/bootstrap-slider.min.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/modernizr.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/bootstrap-clockpicker.min.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/bootstrap-timepicker.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/fullcalendar/lib/moment.min.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/fullcalendar/fullcalendar.js"></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/RGraph/libraries/RGraph.common.core.js" ></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/RGraph/libraries/RGraph.line.js" ></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/RGraph/libraries/RGraph.common.key.js" ></script>
    <script type="text/javascript" src="http://poolmonitor.goldfarbs.net/RGraph/libraries/RGraph.drawing.xaxis.js" ></script>
    <title>Goldfarb Automation</title>
...
function getOutSideTempData() {
    ...
    var URL="http://poolmonitor.goldfarbs.net/cgi-bin/tempdata1.cgi?DataSize="+datasize
...
function getInSideTempData() {
    ...
    var URL="http://poolmonitor.goldfarbs.net/cgi-bin/tempdata_inside.cgi?DataSize="+datasize
    xhttp.open("GET", URL, true);
    xhttp.send();
}
...
function automation(action) {
    ...
    xhttp.onreadystatechange = function() {
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            if (SpaTimer.length==1) {
                document.getElementById("SpaStartTime").value=SpaTimer[0].getAttribute("on")
                document.getElementById("SpaStopTime").value=SpaTimer[0].getAttribute("off")
            } else {
                document.getElementById("SpaStartTime").value=""
		...
		if (note.length > 0) {
                ...
                if (vmail[i].getAttribute("new") == "YES") {
                        ...
                        '<audio controls preload="none" style="width:100%"><source src="http://poolmonitor.goldfarbs.net/voicemail/default/2201/'+mbox+'/msg'+msgnum+'.wav" type="audio/wav"></audio></td>'+
    ...
    var URL="http://poolmonitor.goldfarbs.net/cgi-bin/automation.cgi?ACTION="+action
    xhttp.open("GET", URL, true);
    xhttp.send();
...
<div class="container">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="row">
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=180"   class="btn btn-info btn-lg" role="button" style="width:100px">3 Hours</a>
        </div>
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=360"   class="btn btn-info btn-lg" role="button" style="width:100px">6 Hours</a>
        </div>
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=720"  class="btn btn-info btn-lg" role="button" style="width:100px">12 Hours</a>
        </div>
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=1440"  class="btn btn-info btn-lg" role="button" style="width:100px">24 Hours</a>
        </div>
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=2880"  class="btn btn-info btn-lg" role="button" style="width:100px">2 Days</a>
        </div>
        <div class="col-sm-2">
          <a href="http://poolmonitor.goldfarbs.net/cgi-bin/house1.cgi?DataSize=10080" class="btn btn-info btn-lg" role="button" style="width:100px">1 Week</a>
        </div>
      </div>
    </div>
    ...
    <div id="PoolMenu" class="tab-pane fade">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-2 col-sm-4"><button id="PoolLight_SAM"        onclick="automation('POOL_COLOR&Color=SAM')"        type="button" class="btn btn-lg" style="width:130px;color:white;background: url(http://poolmonitor.goldfarbs.net/images/SAM.png)        repeat-x;">SAM</button></div>
          <div class="col-md-2 col-sm-4"><button id="PoolLight_Party"      onclick="automation('POOL_COLOR&Color=Party')"      type="button" class="btn btn-lg" style="width:130px;color:white;background: url(http://poolmonitor.goldfarbs.net/images/Party.png)      repeat-x;">Party</button></div>
          <div class="col-md-2 col-sm-4"><button id="PoolLight_Caribbean"  onclick="automation('POOL_COLOR&Color=Caribbean')"  type="button" class="btn btn-lg" style="width:130px;color:black;background: url(http://poolmonitor.goldfarbs.net/images/Caribbean.png)  repeat-x;">Caribbean</button></div>
          <div class="col-md-2 col-sm-4"><button id="PoolLight_American"   onclick="automation('POOL_COLOR&Color=American')"   type="button" class="btn btn-lg" style="width:130px;color:black;background: url(http://poolmonitor.goldfarbs.net/images/American.png)   repeat-x;">American</button></div>
          <div class="col-md-2 col-sm-4"><button id="PoolLight_Cal_Sunset" onclick="automation('POOL_COLOR&Color=Cal_Sunset')" type="button" class="btn btn-lg" style="width:130px;color:black;background: url(http://poolmonitor.goldfarbs.net/images/Cal_Sunset.png) repeat-x;">Cal_Sunset</button></div>
          <div class="col-md-2 col-sm-4"><button id="PoolLight_Royal"      onclick="automation('POOL_COLOR&Color=Royal')"      type="button" class="btn btn-lg" style="width:130px;color:white;background: url(http://poolmonitor.goldfarbs.net/images/Royal.png)      repeat-x;">Royal</button></div>
        </div>
        <div class="row">
          <div class="col-md-2 col-sm-4"><button id="PoolLight_Romance" onclick="automation('POOL_COLOR&Color=Romance')" type="button" class="btn btn-lg" style="width:130px;color:white;background: url(http://poolmonitor.goldfarbs.net/images/Romance.png) repeat-x;">Romance</button></div>
    ...
    <div id="HouseMenu" class="tab-pane fade">
      ...
      <div class="row">
	    ...
	    <table border=0><TR valign=center>
            <TD>
               <img id="sprinklerState" src="http://poolmonitor.goldfarbs.net/sprinklers/sprinkler_small.png" usemap="#sprinklerMap">
            </TD>
...
-->
    ...
    <div id="SpaMenu" class="tab-pane fade">
      ...
      <div class="row">
        <div class="row">
          <div class="col-sm-4 text-right"><span style="font-size: 200%">Temperature&nbsp;:</span></div>
        ...
        <div class="row">
          <div class="col-sm-4 text-right"><span style="font-size: 200%">Spa&nbsp;Mode:</span></div>
        ...
        <P>
        <div class="row">
          <div class="col-sm-4 text-right"><span style="font-size: 200%">Spa&nbsp;Heater:</span></div>
	...
	<P>
        <div class="row">
          <div class="col-sm-4 text-right"><span style="font-size: 200%">Main&nbsp;Pump:</span></div>
          <div class="col-sm-2"><button id="MainPump_on"  onClick="automation('MAIN_PUMP_ON')"  type="button" class="btn btn-info btn-lg ">ON</button></div>
          <div class="col-sm-2"><button id="MainPump_off" onClick="automation('MAIN_PUMP_OFF')" type="button" class="btn btn-info btn-lg ">OFF</button></div>
        </div>
        <P>
        <div class="row">
          <div class="col-sm-4 text-right"><span style="font-size: 200%">Spa&nbsp;Jets:</span></div>
      ...
      <hr style="border:0;height:1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));"/>
      <div class="row">
        <div class="col-sm-2 text-right"><span style="font-size: 200%">Spa Start:</span></div>
        <div class="col-sm-4">
<!--
          <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="Done">
            <input type="text" class="form-control" id="SpaStartTime">
            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
          </div>
-->
          <div class="input-group bootstrap-timepicker">
            <input type="text" class="form-control input-lg" id="SpaStartTime">
            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
          </div>
        </div>

        <div class="col-sm-2 text-right"><span style="font-size: 200%">Spa Off:</span></div>
        <div class="col-sm-4">
<!--
          <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="Done">
            <input type="text" class="form-control input-lg" id="SpaStopTime">
            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
          </div>
-->
          <div class="input-group bootstrap-timepicker">
...
<script type="text/javascript" src="http://poolmonitor.goldfarbs.net/bootstrap/js/horiz_tabscroll.js"></script>
<script>
...
\$('#calendar').fullCalendar({
    ...
    events: 'http://poolmonitor.goldfarbs.net/cgi-bin/caldata.cgi'
});
...
//    beforeDone:       function() { console.log("before done");              },
      afterDone: SetSpaSched
});
function SetSpaSched(e) {
        var SpaStartTime=document.getElementById('SpaStartTime').value
        var SpaStopTime=document.getElementById('SpaStopTime').value

	automation(encodeURI('SPASCHEDULE&SpaStartTime='+SpaStartTime+'&SpaStopTime='+SpaStopTime+'&temperature='+spa_temp_target))
}
\$('#SpaStartTime').timepicker({defaultTime: false,showMeridian: false,maxHours: 18});
\$('#SpaStopTime').timepicker( {defaultTime: false,showMeridian: false});
\$('#SpaStartTime').timepicker().on('hide.timepicker',SetSpaSched)
\$('#SpaStopTime').timepicker().on('hide.timepicker',SetSpaSched)
